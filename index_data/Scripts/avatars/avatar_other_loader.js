...
function loadOtherAv() {
  for(var i = 0; i < listOtheravatar.length; i++) {
    var location = "index_data/Resources/Avatars/Other/";
    var format = ".png";
    const list = document.getElementById("OtherSlistAv");
    const asset = document.createElement('img');
    asset.className = "avatar";
    asset.src = location + listOtheravatar[i] + format;
