...
function iconAllLoad() {
  ...
  subiconCode = "index_data/Textures/icon_0.png";
  subiconCode16 = "index_data/Textures/icon_" + dimensions[0] + ".png";
  subiconCode32 = "index_data/Textures/icon_" + dimensions[1] + ".png";
  subiconCode48 = "index_data/Textures/icon_" + dimensions[2] + ".png";
  subiconCode76 = "index_data/Textures/icon_" + dimensions[3] + ".png";
  subiconCode96 = "index_data/Textures/icon_" + dimensions[4] + ".png";
  subiconCode120 = "index_data/Textures/icon_" + dimensions[5] + ".png";
  subiconCode128 = "index_data/Textures/icon_" + dimensions[6] + ".png";
  subiconCode144 = "index_data/Textures/icon_" + dimensions[7] + ".png";
  subiconCode152 = "index_data/Textures/icon_" + dimensions[8] + ".png";
  subiconCode167 = "index_data/Textures/icon_" + dimensions[9] + ".png";
  subiconCode180 = "index_data/Textures/icon_" + dimensions[10] + ".png";
  subiconCode192 = "index_data/Textures/icon_" + dimensions[11] + ".png";
  subiconCode196 = "index_data/Textures/icon_" + dimensions[12] + ".png";
  subiconCode228 = "index_data/Textures/icon_" + dimensions[13] + ".png";
  subiconCode256 = "index_data/Textures/icon_" + dimensions[14] + ".png";
  subiconCode300 = "index_data/Textures/icon_" + dimensions[15] + ".png";
  subiconCode384 = "index_data/Textures/icon_" + dimensions[16] + ".png";
  subiconCode512 = "index_data/Textures/icon_" + dimensions[17] + ".png";
